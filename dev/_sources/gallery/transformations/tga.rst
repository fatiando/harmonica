...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    /home/runner/miniconda3/envs/harmonica-docs/lib/python3.12/site-packages/xrft/xrft.py:560: FutureWarning: Default ifft's behaviour (lag=None) changed! Default value of lag was zero (centered output coordinates) and is now set to transformed coordinate's attribute: 'direct_lag'.
