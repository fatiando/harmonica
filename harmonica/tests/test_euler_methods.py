...
def test_euler_deconv_with_numeric_derivatives():
    "Use numerical derivatives with Euler deconvolution"
    # Add dipole source
...
def test_euler_deconv_with_analytic_derivatives():
    "Use analytical derivatives with Euler deconvolution"
    # Add point source
