...
def normal_gravity(latitude, height):  # pylint: disable=too-many-locals
    ...
    (gravitational + centrifugal) generated by a reference ellipsoid at the
    given latitude and (geometric) height. Uses of a closed form expression
    [LiGotze2001]_ and the current reference ellipsoid defined by
