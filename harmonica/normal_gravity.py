...
def normal_gravity(latitude, height):
    """
    Calculate normal gravity at a certain height.

    Computes the magntiude of the gradient of the gravitational potential
    generated by a reference ellipsoid.
    It makes use of the closed form expression of Li and Gotze (2001) and the
    current reference ellipsoid defined by `set_ellipsoid()`.
