...
# Interpolate data on a regular grid with 400 m spacing. The interpolation
# requires an extra coordinate (upward height). By passing in 500 m, we're
# effectively upward-continuing the data (mean flight height is 200 m).
